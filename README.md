...
Mon second projet permet la gestion des clés à destination des syndics de copropriété intitulé __Trackey__, ce projet a été terminé en 3 mois. J'ai créé une [API via Django_Rest_framework](https://github.com/Nicolas-Dmb/API_Trackey), puis une [partie Frontend](https://github.com/Nicolas-Dmb/Trackey) en React.js. La partie web est accessible via : [Trackey](https://trackey.fr) et l'API via [APITrackey](https://www.apitrackey.fr/) 
La partie mobile est aussi terminé et est accessible via apple store [IOS APP](https://apps.apple.com/fr/app/trackey/id6503019560) concernant android elle est disponible en Beta, il faut me contacter pour que je puisse vous autoriser l'accès à l'application. 

Mes projets à venir : 
- Fanch : un portefolio pour mon cousin qui travaille dans la conception de sac à main. C'est lui qui a entièrement designé le site et je me charge de le mettre en place [Repository](https://github.com/Nicolas-Dmb/Fanch). 
