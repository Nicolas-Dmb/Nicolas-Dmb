...
Mon second projet permet la gestion des clés à destination des syndics de copropriété intitulé __Trackey__. J'ai créé une [API via Django_Rest_framework](https://github.com/Nicolas-Dmb/API_Trackey), puis une [partie Frontend](https://github.com/Nicolas-Dmb/Trackey) en React.js. La partie web est accessible via : [Trackey](https://trackey.fr) et l'API via [APITrackey](https://www.apitrackey.fr/) 
